...
exports.updateVoter = async (req, res) => {
  let { first_name, last_name, dob, cccd, classes, avatar_url, achievement, title, uid, id } = req.body;
  db.query(
    ...
    [first_name, last_name, dob, cccd, classes, avatar_url, achievement, title, uid, id],
    (err, result) => {
      if (!err) {
